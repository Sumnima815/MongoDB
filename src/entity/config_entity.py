...
class DataTransformationConfig:
    ...
    def __post_init__(self):
        os.makedirs(os.path.join(self.data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR), exist_ok=True)
        os.makedirs(os.path.join(self.data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR), exist_ok=True)    
...
class ModelTrainerConfig:
    ...
    def __post_init__(self):
        os.makedirs(os.path.join(self.model_trainer_dir, MODEL_TRAINER_TRAINED_MODEL_DIR), exist_ok=True)
